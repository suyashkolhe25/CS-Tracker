...
function OSTopic({ data, OSupdateData }) {
	/*
		This component takes data related to a particular topic 
		and OSupdateData() from App component
	*/
	/*
	...
	return (
		<div className="DSA-Background">
			...
			<h3 className="text-center mb-4">
				<Link to="/OS/">Topics</Link>/{topicName}
			</h3>
